...
//caffe_set(top_count, -1, argmax_data);
  ...
  {
    // MP: scale rois (size according to original image) to size of conv5_3
    ...
    // MP: determine the height and width of the rois in the conv5_3 scale
    ...
    // MP: determine the bin size in height and width directions
